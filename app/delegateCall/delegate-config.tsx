...
import { optimism, sepolia, foundry } from '@reown/appkit/networks'
...
const projectId = 'dcaaebe91eb70470e45656759cb5e808'
...
// 3. Set the networks
const networks: [AppKitNetwork, ...AppKitNetwork[]] = [foundry, optimism];
